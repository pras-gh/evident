...
from elevate_ingest.memory.cards import (CAPEX, DEFAULT_SOURCES, GUIDANCE,
...
from elevate_ingest.memory.entities import (Evidence, Metric, Observation,
                                            Product, Promise, Risk)

SQL_SEED = Path(__file__).resolve().parents[1] / "sql" / "003_memory_cards.sql"
